...
constexpr auto qt_meta_stringdata_CLASSDataProcessorENDCLASS = QtMocHelpers::stringData(
    "DataProcessor",
    "sendModeChanged",
    "",
    "setSendMode",
...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendModeChanged(); break;
        case 1: _t->setSendMode((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->setReceiveMode((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DataProcessor::sendModeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->sendMode(); break;
        default: break;
        }
...
// SIGNAL 0
void DataProcessor::sendModeChanged()
{
